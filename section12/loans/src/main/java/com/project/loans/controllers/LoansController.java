...
public class LoansController {
    ...
    public ResponseEntity<LoansDTO> getLoanDetails(@RequestHeader("bank-correlation-id") String correlationId,
                                                   ...
                                                   message = LoansConstants.MOBILE_NUMBER_LENGTH)
                                                   String mobileNumber) {
        logger.debug("fetchLoanDetailsMethod start");
        LoansDTO loansDTO = loansService.fetchLoan(mobileNumber);
        logger.debug("fetchLoanDetailsMethod end");
    ...
    public ResponseEntity<LoansContactInfoDTO> getContactInfo() throws InterruptedException {
