...
@Data
@Schema(
        name = SwaggerConstants.CUSTOMER_DETAILS_SCHEMA_NAME,
        description = SwaggerConstants.CUSTOMER_DETAILS_SCHEMA_DESCRIPTION
)
public class CustomerDetailsDTO {
    ...
    @Schema(description = SwaggerConstants.CUSTOMER_FIELD_CARDS_DESCRIPTION)
    private CardsDTO cardsDTO;

    @Schema(description = SwaggerConstants.CUSTOMER_FIELD_LOANS_DESCRIPTION)
